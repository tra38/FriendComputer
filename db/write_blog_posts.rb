...
def essay(args)
  "#{introduction(args[:twitter_id])} #{important_statement(args[:most_important_keyword], args[:twitter_id], args[:most_important_keyword_value])} #{happiest_statement(args[:happiest_keyword], args[:twitter_id], args[:happiest_keyword_value])} #{saddest_statement(args[:saddest_keyword], args[:twitter_id], args[:happiest_keyword_value])} #{conclusion(args[:twitter_id])}"
end
...
def importance(most_important_keyword_value)
  case
...
def important_statement(most_important_keyword, twitter_id, most_important_keyword_value)
  "#{twitter_id} #{importance(most_important_keyword_value)} cares about #{explaining} #{most_important_keyword}."
end

def happiest_statement(happiest_keyword, twitter_id, happiest_keyword_value )
  "#{twitter_id} #{importance(happiest_keyword_value)} enjoys #{explaining} #{happiest_keyword}."
end

def saddest_statement(saddest_keyword, twitter_id, saddest_keyword_value)
